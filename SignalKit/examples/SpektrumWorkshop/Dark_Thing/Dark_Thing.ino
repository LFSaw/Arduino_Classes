...
float upnotes[] = { mtof(79.f),mtof(64.f), mtof(66.f), mtof(68.f)};
...
const IntMap map_eda_to_volume(EDA_MIN, EDA_MAX, 0, 200); 
const IntMap map_responses_to_volume_short(1300, 4000, 0, 200); 
const IntMap map_responses_to_volume_long(1300, 4000, 0, 200); 
...
void updateControl(){
  ...
  vol_ostinato1 = constrain(map_responses_to_volume_short(gsrval), 0, 200); // maps eda activity to ostinato volume
  vol_ostinato2 = constrain(map_responses_to_volume_long(gsrval), 0, 200); // maps eda activity to ostinato volume
